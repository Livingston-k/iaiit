        ...
        <ul class="nav navbar-nav flex align-items-sm-center">
            <li class="nav-item navbar-list__item">
                <div class="media align-items-center">
                    ...
                    <div class="media-body">
                        <a class="card-title m-0" href="{{ route('admin.instructor_profile', $course->user->id) }}">{{ $course->user->name }}</a>
                        ...
                        <div class="accordion__menu collapse show"
                            ...
                            @foreach ($course->lessons as $lesson)
                                <div class="accordion__menu-link active">
                                    ...
                                    <a class="flex lesson-link" href="{{ route('admin.change_lesson', $lesson->id) }}" data-video="{{ URL::asset('uploads/lessons/videos/' . $lesson->video_url) }}" data-thumbnail="{{ URL::asset('uploads/lessons/thumbnails/' . $lesson->thumbnail) }}" data-title="{{ $lesson->title }}">
                                        {{ $lesson->title }}
                                    </a>
