    ...
    <div class="row">
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left mr-12pt">
                        <img src="{{ asset('images/paths/angular_40x40%402x.png') }}"
                             width="40"
                             height="40"
                             alt="Angular"
                             class="rounded">
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left mr-12pt">
                        <img src="{{ asset('images/paths/swift_40x40%402x.png') }}"
                             width="40"
                             height="40"
                             alt="Angular"
                             class="rounded">
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left mr-12pt">
                        <img src="{{ asset('images/paths/wordpress_40x40%402x.png') }}"
                             width="40"
                             height="40"
                             alt="Angular"
                             class="rounded">
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            ...
            <div class="popoverContainer d-none">
                <div class="media">
                    <div class="media-left mr-12pt">
                        <img src="{{ asset('images/paths/react_40x40%402x.png') }}"
                             width="40"
                             height="40"
                             alt="Angular"
                             class="rounded">
